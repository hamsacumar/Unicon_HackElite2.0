            ...
            >
                ...
                <View style={styles.topButtonContainer}>
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate("EditPost", { post })} // 👈 navigate to edit screen
                    >
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            ...
                            // You can replace this with your delete API call
...
const styles = StyleSheet.create({
  ...
  actionButtonText: {
    ...
    contentContainer: { marginTop: 16, paddingHorizontal: 16, paddingBottom: 12 },
